                ...
                <form wire:submit="save" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input wire:model="form.name" type="text" class="w-full border border-neutral-200 p-2 rounded-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white text-sm outline-none focus:ring-1 focus:ring-neutral-400">
                        ...
                        <div class="space-y-1">
                            ...
                            <input wire:model="form.employee_id" type="text" class="w-full border border-neutral-200 p-2 rounded-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white text-sm outline-none focus:ring-1 focus:ring-neutral-400">
                    ...
                    <div class="space-y-1">
                        ...
                        <input wire:model="form.email" type="email" class="w-full border border-neutral-200 p-2 rounded-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white text-sm outline-none focus:ring-1 focus:ring-neutral-400">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input wire:model="form.department" type="text" class="w-full border border-neutral-200 p-2 rounded-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white text-sm outline-none focus:ring-1 focus:ring-neutral-400">
                        ...
                        <div class="space-y-1">
                            ...
                            <input wire:model="form.position" type="text" class="w-full border border-neutral-200 p-2 rounded-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white text-sm outline-none focus:ring-1 focus:ring-neutral-400">
