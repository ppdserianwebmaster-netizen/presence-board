<div class="p-6">
    <div class="flex flex-col gap-6">
        {{-- Header Section: Matches Personnel --}}
        ...
        {{-- Search: Matches Personnel Styling --}}
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
                    @forelse($movements as $m)
                        {{-- Contextual Color Row: Left border appears on hover based on Movement Type --}}
                        <tr wire:key="{{ $m->id }}" 
                            ...
                            <td class="px-6 py-4">
                                <div class="text-xs font-medium text-neutral-600 dark:text-neutral-400 font-mono">
                                    {{ $m->started_at->format('d M, H:i') }} — {{ $m->ended_at?->format('H:i') ?? 'Ongoing' }}
                                </div>
                            ...
                            {{-- Icon Actions: Match Personnel style --}}
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-10 text-center text-neutral-400 italic">No movement records found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    {{-- Modal: Matches Personnel styling --}}
    @if($showingModal)
            ...
            <div class="bg-white dark:bg-neutral-900 rounded-2xl p-6 w-full max-w-lg border border-neutral-200 dark:border-neutral-800 shadow-2xl">
                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea wire:model="form.remark" rows="3" class="w-full border border-neutral-200 p-2 rounded-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white text-sm outline-none focus:ring-1 focus:ring-neutral-400" placeholder="Reason for manual entry..."></textarea>
                    </div>
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-neutral-100 dark:border-neutral-800">
                        ...
                        <button type="submit" class="bg-neutral-900 dark:bg-white dark:text-black text-white px-8 py-2 rounded-xl text-sm font-black shadow-lg hover:opacity-90 transition-all min-w-[140px]">
                            Save Movement
                        </button>
                    </div>
                </form>
